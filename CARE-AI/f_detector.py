...
class eye_blink_detector():
    ...
    def eye_blink(self, gray, rect, COUNTER, TOTAL):
        ...
        if leftEAR < cfg.EYE_AR_THRESH and rightEAR < cfg.EYE_AR_THRESH:
            blink_type = "Both"
        elif leftEAR < cfg.EYE_AR_THRESH:
            blink_type = "Left"
        elif rightEAR < cfg.EYE_AR_THRESH:
            blink_type = "Right"
        else:
            blink_type = "None"
        
        return COUNTER, TOTAL, blink_type
